...
export class Game1Component {
  ...
  products: Product[] = [
    ...
    { id: 3, name: 'Lave-vaisselle', description: 'Gros lave-vaisselle avec une capacité de 8 assiettes avec emplacement couvert', price: 1405.99, rating: 5, reviews: 89, image: '/game_1/lave_vaisselle.jpg' },
    ...
    { id: 6, name: 'La Lune', description: 'La lune, capturé ce lundi, avec une pointe de sel', price: 220054864879541.99, rating: 2, reviews: 73, image: '/game_1/lune.jpg' }
  ];
